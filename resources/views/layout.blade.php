...
<head>
    ...
    <!-- Nhúng các tệp CSS tùy chỉnh của bạn -->
    <link rel="stylesheet" href="{{ asset('frontend/css/bsgrid.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/css/style.min.css') }}" />

    <!-- Nhúng Font Awesome phiên bản 6 -->
    ...
    <footer>
        ...
        <div class="footer__info">
            <div class="footer__info-content">
                <h3>Giới thiệu</h3>
                <p>Website mua bán thú cưng</p>
            </div>
            <div class="footer__info-content">
                <h3>Liên hệ</h3>
                <p>Địa chỉ: 200 Ba Hat StreetWard 9, District 10</p>
                <p>Email: 2051010167lien@ou.edu.vn</p>
                <p>Sđt: 0123456789</p>
            </div>
