                ...
                <a href="{{ route('detail', ['id' => $dogproduct->id_sanpham]) }}">
                    <div class="product">
                        ...
                        <div class="product__content">
                            ...
                            <div class="product__pride">
                                @if ($dogproduct->giakhuyenmai < $dogproduct->giasp && $dogproduct->giakhuyenmai > 0)
                                    <div class="product__pride-oldPride" style="font-size: 16px; text-align: start;">
                                        <span class="Price">
                                            <bdi>
                                                <del>{{ number_format($dogproduct->giasp, 0, ',', '.') }}</del>
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                                    <div class="product__pride-newPride" style="font-size: 24px; text-align: start; color: red;">
                                        <span class="Price">
                                            <bdi>{{ number_format($dogproduct->giakhuyenmai, 0, ',', '.') }}
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                                @else
                                    <div class="product__pride-newPride" style="font-size: 24px; text-align: start;">
                                        <span class="Price">
                                            <bdi>{{ number_format($dogproduct->giasp, 0, ',', '.') }}
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                ...
                <a href="{{ route('detail', ['id' => $catproduct->id_sanpham]) }}">
                    <div class="product">
                        ...
                        <div class="product__content">
                            ...
                            <div class="product__pride">
                                @if ($catproduct->giakhuyenmai < $catproduct->giasp && $catproduct->giakhuyenmai > 0)
                                    <div class="product__pride-oldPride" style="font-size: 16px; text-align: start;">
                                        <span class="Price">
                                            <bdi>
                                                <del>{{ number_format($catproduct->giasp, 0, ',', '.') }}</del>
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                                    <div class="product__pride-newPride" style="font-size: 24px; text-align: start; color: red;">
                                        <span class="Price">
                                            <bdi>{{ number_format($catproduct->giakhuyenmai, 0, ',', '.') }}
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                                @else
                                    <div class="product__pride-newPride" style="font-size: 24px; text-align: start;">
                                        <span class="Price">
                                            <bdi>{{ number_format($catproduct->giasp, 0, ',', '.') }}
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                ...
                <a href="{{ route('detail', ['id' => $choGiong->id_sanpham]) }}">
                    <div class="product">
                        ...
                        <div class="product__content">
                            ...
                            <div class="product__pride">
                                @if ($choGiong->giakhuyenmai < $choGiong->giasp && $choGiong->giakhuyenmai > 0)
                                    <div class="product__pride-oldPride" style="font-size: 16px; text-align: start;">
                                        <span class="Price">
                                            <bdi>
                                                <del>{{ number_format($choGiong->giasp, 0, ',', '.') }}</del>
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                                    <div class="product__pride-newPride" style="font-size: 24px; text-align: start; color: red;">
                                        <span class="Price">
                                            <bdi>{{ number_format($choGiong->giakhuyenmai, 0, ',', '.') }}
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                                @else
                                    <div class="product__pride-newPride" style="font-size: 24px; text-align: start;">
                                        <span class="Price">
                                            <bdi>{{ number_format($choGiong->giasp, 0, ',', '.') }}
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                ...
                <a href="{{ route('detail', ['id' => $meoGiong->id_sanpham]) }}">
                    <div class="product">
                        ...
                        <div class="product__content">
                            ...
                            <div class="product__pride">
                                @if ($meoGiong->giakhuyenmai < $meoGiong->giasp && $meoGiong->giakhuyenmai > 0)
                                    <div class="product__pride-oldPride" style="font-size: 16px; text-align: start;">
                                        <span class="Price">
                                            <bdi>
                                                <del>{{ number_format($meoGiong->giasp, 0, ',', '.') }}</del>
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                                    <div class="product__pride-newPride" style="font-size: 24px; text-align: start; color: red;">
                                        <span class="Price">
                                            <bdi>{{ number_format($meoGiong->giakhuyenmai, 0, ',', '.') }}
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                                @else
                                    <div class="product__pride-newPride" style="font-size: 24px; text-align: start;">
                                        <span class="Price">
                                            <bdi>{{ number_format($meoGiong->giasp, 0, ',', '.') }}
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                ...
                <a href="{{ route('detail', ['id' => $all->id_sanpham]) }}">
                    <div class="product">
                        ...
                        <div class="product__content">
                            ...
                            <div class="product__pride">
                                @if ($all->giakhuyenmai < $all->giasp && $all->giakhuyenmai > 0)
                                    <div class="product__pride-oldPride" style="font-size: 16px; text-align: start;">
                                        <span class="Price">
                                            <bdi>
                                                <del>{{ number_format($all->giasp, 0, ',', '.') }}</del>
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
                                    <div class="product__pride-newPride" style="font-size: 24px; text-align: start; color: red;">
                                        <span class="Price">
                                            <bdi>{{ number_format($all->giakhuyenmai, 0, ',', '.') }}
                                                <span class="currencySymbol">₫</span>
                                            </bdi>
                                        </span>
                                    </div>
