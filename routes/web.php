...
Route::prefix('/')->middleware('admin.admins')->group(function () {
    ...
    Route::get('/admins/edit/{admins}', [AdminsController::class, 'edit'])->name('admins.edit');
    Route::put('/admins/update/{admins}', [AdminsController::class, 'update'])->name('admins.update');
    Route::delete('/admins/{admins}/destroy', [AdminsController::class, 'destroy'])->name('admins.destroy');
});
